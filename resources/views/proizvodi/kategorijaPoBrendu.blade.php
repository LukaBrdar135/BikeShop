...
<hr>
<h2 style="text-align: center; text-transform: uppercase;">{{$kategorijaProizvoda}} {{$activeBrend}}</h2>
<hr>
<div class="container">
    <!-- container -->
    <div class="row">
                ...
                <div class="panel-group category-products" id="accordian">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title"><a href="/proizvodi/{{$kategorijaProizvoda}}">Svi brendovi</a></h4>
                        </div>
                    </div>
