        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                {{ Form::open(array('action' => 'ProizvodController@rezultatPretrage', 'class'=>'form-inline my-2 my-lg-0')) }}
                    <input class="form-control mr-sm-2" type="search" placeholder="Pretraga po imenu" aria-label="Search" name="pretraga" id="pretraga">
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit"><i class="fa fa-search"></i>Pretraga</button>
                    {{ Form::close() }}
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item"><a style="color: hsla(0,0%,100%,.5)" href="/reklamacija">Reklamacije</a></li>
                            <li class="list-inline-item"><a style="color: hsla(0,0%,100%,.5)" href="/racuni">Moji racuni</a></li>
                        </ul>
                    </div><!-- kraj prvog dela -->
                    <div class="col-md-6">
                        <!-- pocetak drugog dela -->
                        <p align="right" style="color:hsla(0,0%,100%,.5)">Bikeshop.com</p>
